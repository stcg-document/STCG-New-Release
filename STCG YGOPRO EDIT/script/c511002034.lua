...
function c511002034.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(511002034,0))
	...
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetDescription(aux.Stringid(511002034,1))
	...
	e3:SetCondition(c511002034.atkcon)
	e3:SetOperation(c511002034.atkop)
	c:RegisterEffect(e3)
end
